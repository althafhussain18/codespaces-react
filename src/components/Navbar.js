...
const Navbar = () => {
    ...
    return (
        <div className="fixed w-full h-[80px] flex justify-between items-center px-4 bg-[#0a192f] text-gray-300">
           <div>
            <img src="https://img.freepik.com/premium-vector/initial-letter-h-logo-design-vector-graphic-alphabet-symbol-corporate-business-identity_565585-689.jpg" alt="logo" style={{width: '100px'}} mt-6></img>
            </div> 
            {/*---menu---*/}
